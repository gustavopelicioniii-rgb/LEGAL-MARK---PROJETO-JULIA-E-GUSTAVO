      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative">
          ...
          <div className="text-white space-y-6 sm:space-y-8 relative z-20 animate-fade-in">
            ...
            <div className="space-y-3 sm:space-y-4 animate-fade-in text-center lg:text-left" style={{ animationDelay: '0.2s' }}>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight drop-shadow-lg">
                Quer Registrar Sua Marca no INPI? Faça Tudo Online com Apoio Jurídico e Acompanhamento Completo.
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/90 leading-relaxed drop-shadow-md max-w-2xl mx-auto lg:mx-0">
                Mais de 1.000 empresas já protegeram o nome do seu negócio com nossa equipe especializada. Consulta gratuita e sem compromisso.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              ...
              >
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                  <span className="truncate">Consultar se posso registrar meu nome</span>
              ...
              >
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                  ...
                  <span>Ver se o nome da minha marca está disponível</span>
                </a>
              </Button>
            </div>
          </div>
          ...
          <div className="relative z-10 animate-fade-in mt-4 lg:mt-0" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Mobile: Show Image */}
            <div className="block lg:hidden relative rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src={heroImage} 
                alt="Registro de Marca no INPI e Proteção de Propriedade Intelectual"
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-4 -right-4 bg-gold text-gold-foreground p-4 rounded-xl shadow-lg z-30">
                <div className="text-2xl font-bold">+1.000</div>
                <div className="text-xs font-medium">Marcas Protegidas</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Mobile Form Below */}
        <div className="block lg:hidden mt-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <ConsultForm />
        </div>
      </div>
    </section>
