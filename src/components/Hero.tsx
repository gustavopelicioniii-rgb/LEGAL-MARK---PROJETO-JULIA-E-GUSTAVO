        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Badge variant="secondary" className="bg-accent/20 text-white border-accent/30 backdrop-blur-sm py-2 px-4 text-sm font-medium">
                <Shield className="w-4 h-4 mr-2" />
                +1.000 Marcas Registradas
              </Badge>
              <Badge variant="secondary" className="bg-gold/20 text-white border-gold/30 backdrop-blur-sm py-2 px-4 text-sm font-medium">
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white/80">100% Seguro</span>
              </div>
            </div>
          </div>
