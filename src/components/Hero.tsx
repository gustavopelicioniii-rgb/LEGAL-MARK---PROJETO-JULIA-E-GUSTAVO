        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative">
          ...
          <div className="text-white space-y-6 sm:space-y-8 relative z-20 animate-fade-in">
            ...
            <div className="space-y-3 sm:space-y-4 animate-fade-in text-center lg:text-left" style={{ animationDelay: '0.2s' }}>
              ...
              {/* Quick Trust Seals */}
              <div className="grid grid-cols-2 gap-2 sm:gap-3 pt-2 max-w-xl mx-auto lg:mx-0">
                ...
                <div className="flex items-center gap-2 text-white/90 text-xs sm:text-sm">
                  <CheckCircle className="w-4 h-4 text-accent flex-shrink-0" />
                  <span>Registro iniciado em até 24h</span>
                </div>
                <div className="flex items-center gap-2 text-white/90 text-xs sm:text-sm">
                  <CheckCircle className="w-4 h-4 text-accent flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 text-white/90 text-xs sm:text-sm">
                  <CheckCircle className="w-4 h-4 text-accent flex-shrink-0" />
                  <span>+1.000 marcas registradas</span>
                </div>
              </div>
              
              {/* Price Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold/20 border border-gold/30 rounded-lg backdrop-blur-sm">
                <span className="text-white font-semibold text-sm sm:text-base">
                  💰 Planos a partir de R$ 850 com tudo incluso
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <Button 
                ...
                size="lg"
                asChild
                className="group w-full sm:w-auto text-sm sm:text-base shadow-lg hover:shadow-xl"
              >
              ...
              {/* Urgency Badge */}
              <div className="bg-accent/20 border border-accent/30 rounded-lg px-4 py-2 backdrop-blur-sm text-center">
                <p className="text-white text-xs sm:text-sm font-medium">
                  ⚡ <strong>Atenção:</strong> Vagas limitadas para novos registros nesta semana
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 animate-fade-in mt-4 lg:mt-0" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-4 -right-4 lg:-bottom-6 lg:-right-6 bg-gold text-gold-foreground p-4 lg:p-6 rounded-xl shadow-lg z-30">
              <div className="text-2xl lg:text-3xl font-bold">+1.000</div>
              <div className="text-xs lg:text-sm font-medium">Marcas Protegidas</div>
            </div>
          </div>
        </div>
      </div>
